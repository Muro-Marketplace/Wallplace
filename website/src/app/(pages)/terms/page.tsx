            ...
            <div className="space-y-10">
              ...
              <div>
                ...
                <div className="space-y-3 text-muted leading-relaxed">
                  ...
                  <p><strong className="text-foreground">Signature on delivery:</strong> Artworks sold for <strong className="text-foreground">&pound;250 or more</strong> require a signed-for delivery service. Artists are responsible for arranging this and must retain proof of signature for at least 12 months.</p>
