  ...
  return (
    <div className="min-h-screen bg-background flex">
      ...
      <div className="flex-1 lg:ml-56 min-w-0">
        {/* Mobile header bar */}
        <div className="lg:hidden flex items-center gap-3 px-4 py-3 bg-white border-b border-border sticky top-14 z-sticky">
          <button
            onClick={() => setSidebarOpen(true)}
            className="p-3 -ml-3 inline-flex items-center justify-center min-h-[44px] min-w-[44px] rounded-sm hover:bg-background transition-colors"
